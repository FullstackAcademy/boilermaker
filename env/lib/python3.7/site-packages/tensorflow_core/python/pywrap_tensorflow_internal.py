...
def TFE_ContextCheckAlive(ctx, worker_name):
    return _pywrap_tensorflow_internal.TFE_ContextCheckAlive(ctx, worker_name)
TFE_ContextCheckAlive = _pywrap_tensorflow_internal.TFE_ContextCheckAlive
